...
setwd("C:/Users/Erika Zanetti/OneDrive - Alma Mater Studiorum Università di Bologna/spatial ecology in r")
...
clv <- viridis(100)
par(mfrow=c(1,2)) 
plot(bandsr17c, col=clv, main="2017")
plot(bandsr23c, col=clv, main="2023")
...
plot(pcsd23, col=clv, main="Spatial variability 2023")
